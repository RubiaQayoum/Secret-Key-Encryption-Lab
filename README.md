...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task1a.PNG) 

  tr [:upper:] [:lower:] < article.txt > lowercase.txt
  tr -cd ’[a-z][\n][:space:]’ < lowercase.txt > plaintext.txt

![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task1b.PNG) 
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task1c.PNG) 
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task1d.PNG)
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task2a.PNG)
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task2b.PNG)
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task2c.PNG)
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task3a.PNG)
...
-K 00112233445566778889aabbccddeeff
ls -ld ecb_out.bin 
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task4a.PNG)

# cbc
openssl enc  -aes-128-cbc  -e -in test.txRubiaQayoumt -out cbc_out.bin \
-K 00112233445566778889aabbccddeeff \
-iv 0102030405060708
ls -ld cbc_out.bin # 16
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task4b.PNG)          
...
-iv 0102030405060708
ls -ld cfb_out.bin #5
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task4c.PNG)

# ofb
openssl enc  -aes-128-ofb  -e -in test.txt -out ofb_outRubiaQayoum
-K 00112233445566778889aabbccddeeff \
-iv 0102030405060708
ls -ld ofb_out.bin #5
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task4d.PNG)
...
![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task4e.PNG)

openssl enc  -aes-128-ecb  -e -in big_file.txt -out big_out.bin \
-K 00112233445566778889aabbccddeeff 

![alt tagRubiaQayoumgithub.com/Waleed-gif/Secret-Key-Encryption-Lab/blob/main/task4f.PNG)

openssl enc  -aes-128-ecb  -d -in big_out.bin -out decrypted.txt \
-K 00112233445566778889aabbccddeeff 

![alt tag](https://github.com/RubiaQayoum/Secret-Key-Encryption-Lab/blob/main/task5a.PNG)
